...
// ✅ Ferrari logo from your repo (GitHub Pages)
...
// Ergast constructorId for Ferrari
...
async function buildJson() {
  ...
  try {
    ...
    if (ctorRow) {
      teamStanding = {
        ...
        wins: ctorRow.wins ?? "-",
        originalTeam: ctorRow?.Constructor?.name ?? "Ferrari",
      };
    }
  ...
  return {
    ...
    ferrari: {
      team: "Ferrari",
      teamLogoPng: getTeamLogoUrl(FERRARI_LOGO_FILE),
      teamStanding,
    },
    lastRace,
    drivers,
